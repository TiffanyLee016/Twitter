...
class HomeTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tweetTable.estimatedRowHeight = 160
 ...
 */
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = self.tableView.dequeueReusableCell(withIdentifier: "tweetCell", for: indexPath) as! TweetTableViewCell
        ...
        cell.tweedId = tweetArray [indexPath.row]["id"] as! Int
        cell.setRetweeted(isRetweed: tweetArray[indexPath.row]["retweeted"] as! Bool)
            return cell
